  ...
  return (
    <>
      ...
      <div className="container text-center mt-5 mb-5 home-container">
        <h3 className="pt-5 text-uppercase tiny-text">Say 'I Do' to Expert Guidance</h3>
      ...
      <div className="image-overlay position-relative">
        <div className="overlay position-absolute bottom-0 end-0">
          ...
          <button className=" btn overlay-tiny-text mb-3">Discover<ArrowOutwardIcon className="arrow" style={{ color: "#E7E7E6" }}/></button>
        </div>
      </div>
