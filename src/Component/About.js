...
const About=()=>{
    return(
      ...
      <div className="container mt-5 about">
        ...
        Airvy atelier was established in 2015 by Evi Jesumuyiwa. She began designing as a teen in high school, creating sketches and making little dresses from scrap pieces she could find. In her university years, she had started creating designs for friends and other school mates while outsourcing the production to tailors. She graduated with a distinction in Business Administration and began learning how to make dresses immediately after her graduation. She has since evolved in the fashion industry, building her team and creating masterpieces for brides and other clients from various parts of the world including Canada, U.S, Ireland, U.K, Liberia, France, Austria and so on. Evi's vision is to be among the leading couturiers in the world and she works towards this by accentuating the beauty in every woman through carefully- made, custom fitting garments. 
        </p>
        <p className="designer-intro ">“I'm a lover of art in fashion who's passionate about enchanting dresses. I believe dresses should be lush, dreamy and captivating so my daily goal is to create such pieces to satisfy you and make you elegant!” </p>

        <p className="text-left">With Love,</p>
        <p className="text-left">
        Evi Jesumuyiwa <br />
        <span className="tiny">Designer & Creative director</span>
        </p>
        <p className="text-left signature">Evi</p>
      </div>
